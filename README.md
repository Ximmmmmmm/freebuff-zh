...
[![Target](https://img.shields.io/badge/目标-Freebuff%20Desktop%20v0.0.131-blue)](https://freebuff.com)
...
Freebuff Desktop（`@codebuff/freebuff-desktop` v0.0.131）的**简体中文汉化包**，直接修改已打包产物，无需源码、不涉及任何联网改动。
