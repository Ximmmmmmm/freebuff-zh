...
[![Target](https://img.shields.io/badge/目标-Freebuff%20Desktop%20v0.0.92-blue)](https://freebuff.com)
...
Freebuff Desktop（`@codebuff/freebuff-desktop` v0.0.92）的**简体中文汉化包**，直接修改已打包产物，无需源码、不涉及任何联网改动。
...
- **可复现构建**：`build.sh` 从原版 + 词典 + 补丁**逐字节重建**汉化产物（v0.0.77 曾对照 Release 产物验证；v0.0.83 / v0.0.87 / v0.0.88 / v0.0.90 / v0.0.91 / v0.0.92 适配经防呆自检通过）
- **v0.0.92 适配**：随版本自动重映射 2 条模板变量、复核新版模型与界面文案；v0.0.88 起 Freebucks 钱包额度系统（每日额度 + 钱包 + 按小时计价的会话购买）全新界面全套中文化
