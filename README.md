...
[![Target](https://img.shields.io/badge/目标-Freebuff%20Desktop%20v0.0.127-blue)](https://freebuff.com)
...
Freebuff Desktop（`@codebuff/freebuff-desktop` v0.0.127）的**简体中文汉化包**，直接修改已打包产物，无需源码、不涉及任何联网改动。
...
- **词典驱动**：`dict.json`（exact 1311 / template 290 / code 9 / pattern 80），幂等应用、可审计
- **可复现构建**：`build.sh` 从原版 + 词典 + 补丁**逐字节重建**汉化产物  （v0.0.77 曾对照 Release 产物验证；v0.0.83 / v0.0.87 / v0.0.88 / v0.0.90 / v0.0.91 / v0.0.92 / v0.0.103 / v0.0.104 / v0.0.105 / v0.0.106 / v0.0.107 / v0.0.108 / v0.0.109 / v0.0.110 / v0.0.112 / v0.0.113 / v0.0.114 / v0.0.120 / v0.0.123 / v0.0.124 / v0.0.126 / v0.0.127 适配经防呆自检通过）
