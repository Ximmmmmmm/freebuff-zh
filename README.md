...
[![Target](https://img.shields.io/badge/目标-Freebuff%20Desktop%20v0.0.83-blue)](https://freebuff.com)
...
Freebuff Desktop（`@codebuff/freebuff-desktop` v0.0.83）的**简体中文汉化包**，直接修改已打包产物，无需源码、不涉及任何联网改动。
...
- **词典驱动**：`dict.json`（exact 742 / template 121 / code 4 / pattern 45），幂等应用、可审计
